...
{
$aaid=$_GET['aaid'];
$adata=mysql_fetch_assoc(mysql_query("select * from accomodation where id='$aaid' "));
}

if(isset($_REQUEST['add']))
{
$ac_name=$_POST['ac_name'];
  mysql_query("INSERT INTO `accomodation`(`id`, `name`) VALUES ('','$ac_name')");
 
     $_SESSION['mymsg']='Add Successfully';
	  echo "<script>window.location='add-accommo.php';</script>";
	  exit(); 
}
...
{
$ac_name=$_POST['ac_name'];
  mysql_query("update accomodation set name='$ac_name' where id='$aaid'");
 
     $_SESSION['mymsg']='Update Successfully';
	 echo "<script>window.location='add-accommo.php?aaid=".$aaid."';</script>";
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Edit Accommodation</h5>
										<div class="heading-elements">
											<ul class="icons-list">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
						<input type="text" class="form-control" name="ac_name" value="<?php echo $adata['name']; ?>">
											</div>
										</div>
