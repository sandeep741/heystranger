...
{
$aaid=$_GET['aaid'];
$adata=mysql_fetch_assoc(mysql_query("select * from surroundings where id='$aaid' "));
}

if(isset($_REQUEST['add']))
{
$surr=$_POST['surr'];
  mysql_query("INSERT INTO `surroundings`(`id`, `name`) VALUES ('','$surr')");
 
     $_SESSION['mymsg']='Add Successfully';
	  echo "<script>window.location='add-surround.php';</script>";
	  exit(); 
}
...
{
$surr=$_POST['surr'];
  mysql_query("update `surroundings` set name='$surr' where id='$aaid'");
 
     $_SESSION['mymsg']='Update Successfully';
	 echo "<script>window.location='add-surround.php?aaid=".$aaid."';</script>";
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Surroundings</span></h4>
						</div>
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Edit Surroundings</h5>
										<div class="heading-elements">
											<ul class="icons-list">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
						<input type="text" class="form-control" name="surr" value="<?php echo $adata['name']; ?>">
											</div>
										</div>
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Add Surroundings</h5>
										<div class="heading-elements">
											<ul class="icons-list">
						                		<li><a data-action="collapse"></a></li>
						                		<li><a data-action="reload"></a></li>
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-lg-3 control-label">Name</label>
											<div class="col-lg-9">
						<input type="text" class="form-control" name="surr">
											</div>
										</div>
