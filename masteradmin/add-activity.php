...
{
$aaid=$_GET['aaid'];
$adata=mysql_fetch_assoc(mysql_query("select * from activity where id='$aaid' "));
}

if(isset($_REQUEST['add']))
{
$act_name=$_POST['act_name'];
  mysql_query("INSERT INTO `activity`(`id`, `name`) VALUES ('','$act_name')");
 
     $_SESSION['mymsg']='Add Successfully';
	  echo "<script>window.location='add-activity.php';</script>";
	  exit(); 
}
...
{
$act_name=$_POST['act_name'];
  mysql_query("update activity set name='$act_name' where id='$aaid'");
 
     $_SESSION['mymsg']='Update Successfully';
	 echo "<script>window.location='add-activity.php?aaid=".$aaid."';</script>";
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Activity</span></h4>
						</div>
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Edit Activity</h5>
										<div class="heading-elements">
											<ul class="icons-list">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
						<input type="text" class="form-control" name="act_name" value="<?php echo $adata['name']; ?>">
											</div>
										</div>
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Add Activity</h5>
										<div class="heading-elements">
											<ul class="icons-list">
						                		<li><a data-action="collapse"></a></li>
						                		<li><a data-action="reload"></a></li>
