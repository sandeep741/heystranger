...
{
$aaid=$_GET['aaid'];
$adata=mysql_fetch_assoc(mysql_query("select * from room_type where id='$aaid' "));
}

if(isset($_REQUEST['add']))
{
$room_type_name=$_POST['room_type_name'];
  mysql_query("INSERT INTO `room_type`(`id`, `name`) VALUES ('','$room_type_name')");
 
     $_SESSION['mymsg']='Add Successfully';
	  echo "<script>window.location='add-room-type.php';</script>";
	  exit(); 
}
...
{
$room_type_name=$_POST['room_type_name'];
  mysql_query("update room_type set name='$room_type_name' where id='$aaid'");
 
     $_SESSION['mymsg']='Update Successfully';
	 echo "<script>window.location='add-room-type.php?aaid=".$aaid."';</script>";
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Room Type</span></h4>
						</div>
								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
						<input type="text" class="form-control" name="room_type_name" value="<?php echo $adata['name']; ?>">
											</div>
										</div>
