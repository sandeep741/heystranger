...
{
$aaid=$_GET['aaid'];
$adata=mysql_fetch_assoc(mysql_query("select * from paymode where id='$aaid' "));
}

if(isset($_REQUEST['add']))
{
$am_name=$_POST['am_name'];
  mysql_query("INSERT INTO `paymode`(`id`, `name`) VALUES ('','$am_name')");
 
     $_SESSION['mymsg']='Add Successfully';
	  echo "<script>window.location='add-pay-mode.php';</script>";
	  exit(); 
}
...
{
$am_name=$_POST['am_name'];
  mysql_query("update paymode set name='$am_name' where id='$aaid'");
 
     $_SESSION['mymsg']='Update Successfully';
	 echo "<script>window.location='add-pay-mode.php?aaid=".$aaid."';</script>";
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Payment Mode</span></h4>
						</div>
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Edit Payment Mode</h5>
										<div class="heading-elements">
											<ul class="icons-list">
