...
{
$aaid=$_GET['aaid'];
$adata=mysql_fetch_assoc(mysql_query("select * from features where id='$aaid' "));
}

if(isset($_REQUEST['add']))
{
$am_name=$_POST['am_name'];
  mysql_query("INSERT INTO `features`(`id`, `name`) VALUES ('','$am_name')");
 
     $_SESSION['mymsg']='Add Successfully';
	  echo "<script>window.location='add-feature.php';</script>";
	  exit(); 
}
...
{
$am_name=$_POST['am_name'];
  mysql_query("update features set name='$am_name' where id='$aaid'");
 
     $_SESSION['mymsg']='Update Successfully';
	 echo "<script>window.location='add-feature.php?aaid=".$aaid."';</script>";
					...
					<div class="row">
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Edit Feature</h5>
										<div class="heading-elements">
											<ul class="icons-list">
						...
						<input type="text" class="form-control" name="am_name" value="<?php echo $adata['name']; ?>">
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Add Feature</h5>
										<div class="heading-elements">
											<ul class="icons-list">
						                		<li><a data-action="collapse"></a></li>
						                		<li><a data-action="reload"></a></li>
