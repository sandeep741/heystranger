...
{
$aaid=$_GET['aaid'];
$adata=mysql_fetch_assoc(mysql_query("select * from amenity where id='$aaid' "));
}

if(isset($_REQUEST['add']))
{
$am_name=$_POST['am_name'];
  mysql_query("INSERT INTO `amenity`(`id`, `name`) VALUES ('','$am_name')");
 
     $_SESSION['mymsg']='Add Successfully';
	  echo "<script>window.location='add-amenity.php';</script>";
	  exit(); 
}
...
{
$am_name=$_POST['am_name'];
  mysql_query("update amenity set name='$am_name' where id='$aaid'");
 
     $_SESSION['mymsg']='Update Successfully';
	 echo "<script>window.location='add-amenity.php?aaid=".$aaid."';</script>";
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Amenity</span></h4>
						</div>
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Edit Amenity</h5>
										<div class="heading-elements">
											<ul class="icons-list">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-lg-9">
						<input type="text" class="form-control" name="am_name" value="<?php echo $adata['name']; ?>">
											</div>
										</div>
							...
							<form  class="form-horizontal" method='POST'>
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Add Amenity</h5>
										<div class="heading-elements">
											<ul class="icons-list">
						                		<li><a data-action="collapse"></a></li>
						                		<li><a data-action="reload"></a></li>
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-lg-3 control-label">Name</label>
											<div class="col-lg-9">
						<input type="text" class="form-control" name="am_name">
											</div>
										</div>
