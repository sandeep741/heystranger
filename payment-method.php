...
include("lib/config.php");
	  ...
	  if($_SESSION['new_partner_id']=='' || $_SESSION['pkg_session']=='')
	  {
                  ...
                  <div class="col-sm-12">
                     <div class="post-5200 page type-page status-publish hentry">
                        <div class="entry-content">
                         ...
                         <form  method="POST" class="checkout woocommerce-checkout" action='action.php'>
                                 <div class="row">
                                    <div class="col-sm-8">
                                       <input type='hidden' value='insertreg_detail' name='action' />
                                       <div id="order_review" class="woocommerce-checkout-review-order mt20">
                                          <div id="payment" class="woocommerce-checkout-payment">
                                             <ul class="wc_payment_methods payment_methods methods">
                                                <li class="wc_payment_method payment_method_bacs">
                                                   <input class='btn btn-primary'  type='submit' onclick="return confirm('Are you sure?');" name='bank_submit' value='Bank Transfer' />
                                                </li>
