...
<html lang="en-US" class="full">
   ...
   <body class="page-template page-template-template-login page-template-template-login-php page page-id-31 full  wide menu_style1 topbar_position_default enable_sticky_menu wpb-js-composer js-comp-ver-5.0 vc_responsive">
   ...
   <?php include('header.php'); ?>
            ...
            <div class="full-page  ">
               <div class="bg-holder full">
                  ...
                  <div class="bg-holder-content full text-white">
                     ...
                     <img src="images/logo-white.png" alt="logo" title="Traveler">
                     </a>
					 
					 
					 
                     <div class="login full-center">
					 <?php if($_SESSION['myerror']!=''){ ?><h4 style='text-align:center;background:white;color:green;font-weight:bold'><?php echo $_SESSION['myerror']; unset($_SESSION['myerror']); ?> </h4><?php } ?>
                              ...
                              <div class="col-md-4">
								 ...
								 <input type='hidden' name='action' value='partner_login'/>
                                    ...
                                    <div class="form-group form-group-ghost form-group-icon-left">
                                       ...
                                       <input id="field-login_name" name="username" class="form-control" placeholder="e.g. johndoe" type="text" value="" />
                                    </div>
                                    <div class="form-group form-group-ghost form-group-icon-left">
                                       <label for="field-login_password">Password</label>
                                       <i class="fa fa-lock input-icon input-icon-show"></i>
                                       <input id="field-login_password" name="password" class="form-control" type="password"  placeholder="my secret password" />
                                    </div>
      ...
      <style>
         .st_1487264160{
         background: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/uploads/2014/11/lhotel_porto_bay_sao_paulo_luxury_suite_800x600.jpg)
         }
      </style>
      ...
      <script type="text/html" id="tmpl-media-library-view-switcher">
         <a href="/page-login/?mode=list" class="view-list">
         	<span class="screen-reader-text">List View</span>
         </a>
         <a href="/page-login/?mode=grid" class="view-grid current">
      ...
      <script type='text/javascript'>
         /* <![CDATA[ */
         var woocommerce_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/page-login\/?wc-ajax=%%endpoint%%"};
         /* ]]> */
      </script>
      ...
      <script type='text/javascript'>
         /* <![CDATA[ */
         var wc_cart_fragments_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/page-login\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
         /* ]]> */
      </script>
