...
{
header("Location: my-package.php");
exit();
}

if(isset($_REQUEST['sub_detail']))
{
$accomodation=$_POST['accomodation'];
$venue_conference=$_POST['venue_conference'];
$transport=$_POST['transport'];
$additional=$_POST['additional'];

$_SESSION['accomodation']=$accomodation;
$_SESSION['venue_conference']=$venue_conference;
...
Accommodation properties would you like to advertise<span class="color-red"> (*)</span></label>
									  ...
									  <select name="accomodation" required class="form-control" >
									  <option value="">-----No. Of Accommodations-----</option>
									  <?php
									  if($_SESSION['pkg_session']==3)
									  {
									  $zx=7;
									  }
                                 ...
                                 <div class="col-md-6">
                                  ...
                                  <select name="venue_conference" required class="form-control" >
                              ...
                              <div class="row mt20 data_field">
                                 <div class="col-md-6">
                                    <div class="form-group  form-group-icon-left">
                                       ...
                                       <i class="fa fa-user input-icon input-icon-show"></i>
                                       <select name="transport" required class="form-control" >
...
Additional Service <span class="color-red"> (*)</span></label>
                                       <i class="fa fa-lock input-icon input-icon-show"></i>
                                       <select name="additional" required class="form-control" >
