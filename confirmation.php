...
<html lang="en-US">
   ...
   <body class="hotel_room-template-default single single-hotel_room postid-4599 logged-in  wide menu_style1 topbar_position_default enable_sticky_menu wpb-js-composer js-comp-ver-5.0 vc_responsive">
     <?php include('header.php'); ?>
            ...
            <div class="container">
               <div class="breadcrumb">
                  <ul class="breadcrumb  mt15">
                     ...
                     <li><a href="#" title="Grand Hyatt Hotel">Grand Hyatt Hotel</a></li>
                     <li class="active">Executive Room With Lake View</li>
                  </ul>
               </div>
            </div>
            <div id="single-room"  class="booking-item-details">
               <div class="thumb">
                  <img width="1600" height="500" src="images/613-1600x500.jpg" class="fancy-responsive wp-post-image" alt="" />
               </div>
               <div class="container">
                                 ...
                                 <div class="booking-item-details no-border-top">
                                    <div class="row">
                                       <div class="col-xs-12 col-md-3 avatar">
                                          <img src="images/New_York_Hilton_Midown_Logo.jpg" alt="avatar">
                                       </div>
                                       <div class="col-xs-12 col-md-9">
                                          <h2 class="title">Executive Room With Lake View</h2>
                                          <div class="booking-item-rating" style="border:none">
                                             <ul class="icon-group booking-item-rating-stars">
                                                <div class="pull-left" style="margin-right: 20px;"><strong><a href="#" title="">Grand Hyatt Hotel</a></strong></div>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-xs-6 col-sm-3">
                                                <div class="facility-item" rel="tooltip" data-placement="top" title="" data-original-title="Room footage (square feet)">
                                                   ...
                                                   <h5 class="booking-item-feature-sign">250 m</h5>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="wpb_column column_container col-md-12">
                                       <div class="vc_column-inner ">
                                          <div class="wpb_wrapper">
                                                      ...
                                                      <div class="row">
                                                         ...
                                                         <div class="col-xs-7 col-sm-9">
                                                            <div class="row">
                                                               ...
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>Bed number: <strong>3</strong></span>
                                                               </div>
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>Children number: <strong>4</strong></span>
                                                               </div>
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>Room Footage: <strong>250</strong></span>
                                                               </div>
                                                            </div>
                                                         </div>
                                                      </div>
                                                   ...
                                                   <div class="col-xs-12 item">
                                                      <div class="row">
                                                         ...
                                                         <div class="col-xs-7 col-sm-9">
                                                            <div class="row">
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>Price: <strong>$350,00</strong></span>
                                                               </div>
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>Discount: <strong>10 </strong> %</span>
                                                               </div>
                                                            </div>
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="row">
                                                         ...
                                                         <div class="col-xs-7 col-sm-9">
                                                            <div class="row">
                                                               ...
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>
                                                                  Standard Double-Double Room                        	</span>
                                                               </div>
                                                            </div>
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="row">
                                                         ...
                                                         <div class="col-xs-7 col-sm-9">
                                                            <div class="row">
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>
                                                                  <i class="fa fa-crosshairs mr10"></i>
                                                                  Air Conditioning                        	</span>
                                                               </div>
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>
                                                                  <i class="im im-tv mr10"></i>
                                                                  Flat Screen TV                        	</span>
                                                               </div>
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>
                                                                  <i class="im im-patio mr10"></i>
                                                                  Patio                        	</span>
                                                               </div>
                                                               <div class="col-xs-12 col-sm-6 sub-item">
                                                                  <span>
                                             ...
                                             <div class="row calendar-wrapper mb20" data-post-id="4599">
                                             ...
                                             <div class="fotorama" data-allowfullscreen="true" data-nav="thumbs"  style="margin-top: 20px;">
                                                <img width="800" height="600" src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/uploads/st_uploadfont/exc5-1024x10244-800x600.jpg" class="attachment-800x600x size-800x600x" alt="" /><img width="800" height="600" src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/uploads/st_uploadfont/appt1-1024x10243-800x600.jpg" class="attachment-800x600x size-800x600x" alt="" /><img width="800" height="600" src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/uploads/st_uploadfont/appt-1024x10242-800x600.jpg" class="attachment-800x600x size-800x600x" alt="" /><img width="800" height="600" src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/uploads/st_uploadfont/APTO-315-2-1-800x6003-800x600.jpg" class="attachment-800x600x size-800x600x" alt="" /><img width="800" height="600" src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/uploads/st_uploadfont/comf1-1024x10243-800x600.jpg" class="attachment-800x600x size-800x600x" alt="" />
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="vc_row wpb_row vc_inner vc_custom_1439363062743">
                                    <div class="wpb_column column_container col-md-12">
                                       <div class="vc_column-inner ">
                                          <div class="wpb_wrapper">
                                                ...
                                                <div class="box bg-gray">
                                                   <div id="respond" class="comment-respond">
                                                      ...
                                                      <form action="#" method="post" id="commentform" class="comment-form" novalidate>
                                                         ...
                                                         <p class="form-submit"><input name="submit" type="submit" id="submit" class="submit" value="Leave a Review" /> <input type='hidden' name='comment_post_ID' value='4599' id='comment_post_ID' />
                                 ...
                                 <div class="hotel-room-form">
                                    ...
                                    <div class="price bgr-main clearfix">
                                       <div class="pull-left">
                                          ...
                                          $350,00                </span>
                                          <span class="text-lg">$315,00</span>
                                       </div>
                                    ...
                                    <form id="form-booking-inpage" class="single-room-form" method="post">
                                       ...
                                       <input type="hidden" id="room_search" name="room_search" value="c204497b27" /><input type="hidden" name="_wp_http_referer" value="#" />
                                       <div class="input-daterange" data-date-format="mm/dd/yyyy" data-booking-period="0">
                                          <div class="row">
                                       ...
                                       <div class="extra-price">
                                          <table class="table" style="table-layout: fixed;">
                                             <tr class="">
                                                <td width="70%">
                                                   <label for="field-extra_adult" class="ml20 mt5">Adult ($40,00)</label>
                                                   <input type="hidden" name="extra_price[price][extra_adult]" value="40">
                                             ...
                                             <tr class="">
                                                <td width="70%">
                                                   <label for="field-extra_child" class="ml20 mt5">Child ($20,00)</label>
                                                   <input type="hidden" name="extra_price[price][extra_child]" value="20">
                                                   <input type="hidden" name="extra_price[title][extra_child]" value="Child">
                                                </td>
                                                <td>
                                                   <select  style="width: 100px" class="form-control app" name="extra_price[value][extra_child]" id="field-extra_child">
                                                      <option   value="0">0</option>
                                                      <option   value="1">1</option>
                                                      <option   value="2">2</option>
                                                      <option   value="3">3</option>
                                             ...
                                             <tr class="">
                                                <td width="70%">
                                                   <label for="field-extra_vip" class="ml20 mt5">Service VIP  ($50,00)</label>
                                                   <input type="hidden" name="extra_price[price][extra_vip]" value="50">
                                                   <input type="hidden" name="extra_price[title][extra_vip]" value="Service VIP ">
                                                </td>
                                                <td>
                                                   <select  style="width: 100px" class="form-control app" name="extra_price[value][extra_vip]" id="field-extra_vip">
                                                      <option   value="0">0</option>
                                                      <option   value="1">1</option>
                                                      <option   value="2">2</option>
                                                   </select>
                                       ...
                                       <input name="item_id" value="185" type="hidden">
                                       <input name="room_id" value="4599" type="hidden">
                                    </form>
                                 </div>
                              </div>
                           </div>
      ...
      <script type="text/html" id="tmpl-media-library-view-switcher">
         <a href="/hotel_room/executive-room-with-lake-view-2/?check_in=02%2F21%2F2017&#038;check_out=02%2F22%2F2017&#038;room_num_search=1&#038;child_number=0&#038;adult_number=1&#038;mode=list" class="view-list">
         	<span class="screen-reader-text">List View</span>
         </a>
         <a href="/hotel_room/executive-room-with-lake-view-2/?check_in=02%2F21%2F2017&#038;check_out=02%2F22%2F2017&#038;room_num_search=1&#038;child_number=0&#038;adult_number=1&#038;mode=grid" class="view-grid current">
      ...
      <link rel='stylesheet' id='fullcalendar-css-css'  href='css/fullcalendar.min.css' type='text/css' media='all' />
      <link rel='stylesheet' id='availability-css'  href='css/availability.css' type='text/css' media='all' />
      ...
      <script type='text/javascript' src='js/single-hotel-room.js'></script>
