...
<html lang="en-US">
   ...
   <body class="page-template-default page page-id-5200 logged-in woocommerce-checkout woocommerce-page  wide menu_style1 topbar_position_default enable_sticky_menu wpb-js-composer js-comp-ver-5.0 vc_responsive">
                                       ...
                                       <div class="col2-set" id="customer_details">
                                          <div class="">
                                             <div class="woocommerce-billing-fields">
                                                ...
                                                <p class="form-row form-row form-row-first validate-required validate-email" id="billing_email_field"><label for="billing_email" class="">Email Address <abbr class="required" title="required">*</abbr></label><input type="email" class="input-text " name="billing_email" id="billing_email" placeholder=""  autocomplete="email" value="victorglobalmlm@gmail.com"  /></p>
                                          ...
                                          <div id="payment" class="woocommerce-checkout-payment">
                                             ...
                                             <div class="form-row place-order">
                                                ...
                                                <p class="form-row terms wc-terms-and-conditions">
                                                   ...
                                                   <label for="terms" class="checkbox">I&rsquo;ve read and accept the <a href="http://travelerdemo.wpengine.com/terms-and-conditions/" target="_blank">terms &amp; conditions</a> <span class="required">*</span></label>
                                                ...
                                                <input type="hidden" id="_wpnonce" name="_wpnonce" value="29397a7dad" /><input type="hidden" name="_wp_http_referer" value="/checkout-2/" />
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-sm-4">
                                       <div class="woocommerce-checkout-review-order-table booking-item-payment">
                                          <header class="clearfix">
                                             <a class="booking-item-payment-img" target="_blank" href="http://travelerdemo.wpengine.com/hotel/holiday-inn-express-kennedy-airport/">
                                             ...
                                             <h5 class="booking-item-payment-title">
                                                <a href="http://travelerdemo.wpengine.com/hotel/holiday-inn-express-kennedy-airport/" target="_blank">Grand Hyatt Hotel </a>
                                             </h5>
                                             $315,00
                                          </header>
                                          <header class="clearfix">
                                             <a class="booking-item-payment-img" target="_blank" href="#">
                                             <img width="1600" height="1067" src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/uploads/2014/11/Standard_Room_1_Double_Bed.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />                </a>
                                             <h5 class="booking-item-payment-title">
                                          ...
                                          <ul class="booking-item-payment-details">
                                             <li>
                                                <ul class="booking-item-payment-price">
                                                   <li>
                                                      <p class="booking-item-payment-price-title">Subtotal
                                                      </p>
                                                      <p class="booking-item-payment-price-amount">$806,40</p>
                                                   </li>
                                                </ul>
                                             </li>
                                          </ul>
                                          <p class="booking-item-payment-total">Total:
                                             <span><strong>$806,40</strong> </span>
                                          </p>
                                       </div>
                                    </div>
                                 </div>
      ...
      <script type="text/html" id="tmpl-media-library-view-switcher">
         <a href="/checkout-2/?mode=list" class="view-list">
         	<span class="screen-reader-text">List View</span>
         </a>
         <a href="/checkout-2/?mode=grid" class="view-grid current">
