...
<html lang="en-US">
   ...
   <body class="page-template page-template-template-home page-template-template-home-php page page-id-453 logged-in  wide menu_style1 topbar_position_default enable_sticky_menu wpb-js-composer js-comp-ver-5.0 vc_responsive">
                                 ...
                                 <div class="bg-holder full">
                                          ...
                                          <div class="rel full-height div_tagline">
                                             ...
                                             <div class="container">
                                                <div class="search-tabs search-tabs-bg search-tabs-abs-bottom  no-boder-search ">
                                                  <h3 style="text-align:center; color:#fff;">Where Do You Want to Go ?</h3>
                                                   <div class="tabbable">
                                                      <ul class="nav nav-tabs" id="myTab">
                                                         ...
                                                         <li >
                                                            <a href="#tab-custom_services"
                                                               data-toggle="tab"><i class="fa fa-plane"></i><span>Services Provider</span></a>
                                                         </li>
                                                      </ul>
                                                      <div class="tab-content">
                                                               ...
                                                               <div class="row">
                                                                  <div class=" col-md-2 col-lg-2 col-sm-12 col-xs-12 ">
                                                                     <div class="form-group form-group- form-group-icon-left">
                                                                        <label for="field-hotel-location">Country</label>
                                                                        <i class="fa fa-map-marker input-icon"></i>
                                                                        <div class="st-select-wrapper">
                                                                           <input id="field-hotel-location" autocomplete="off" type="text" name="location_name" value="" class="form-control st-location-name  required" placeholder="Country">
                                                                   ...
                                                                   <div class=" col-md-2 col-lg-2 col-sm-12 col-xs-12 ">
                                                                     <div class="form-group form-group- form-group-icon-left">
                                                                        <label for="field-hotel-location">Destination</label>
                                                                        <i class="fa fa-map-marker input-icon"></i>
                                                                        <div class="st-select-wrapper">
                                                                           <input id="field-hotel-location" autocomplete="off" type="text" name="location_name" value="" class="form-control st-location-name  required" placeholder="Destination">
                                                         ...
                                                         <div class="tab-pane fade " id="tab-custom_services">
                                                            <h2 class='mb20'>Services Provider</h2>
                                                            <form role="search" method="get" class="search main-search" action="#" target="_blank">
                                                               <div class="row">
                                                                  <div class=" col-md-6 col-lg-6 col-sm-12 col-xs-12 ">
                                                                     <div class="form-group form-group- form-group-icon-left">
                                                                        <label for="location_from">From</label>
                                    ...
                                    <div class="owl-carousel owl-slider owl-carousel-area" id="owl-carousel-slider" data-nav="false">
                                       <div class="bg-holder full">
                                          ...
                                          <div class="bg-img" style="background-image:url(images/slider-99.jpg);"></div>
                                       </div>
                                       <div class="bg-holder full">
                                          <div class="bg-mask st_1487265575"></div>
                                          <div class="bg-img" style="background-image:url(images/bridge_1280x848.jpg);"></div>
                                       </div>
                                       <div class="bg-holder full">
                                          <div class="bg-mask st_1487265575"></div>
                                          <div class="bg-img" style="background-image:url(images/gaviota_en_el_top_2048x1365.jpg);"></div>
                                       </div>
                                       <div class="bg-holder full">
                                          <div class="bg-mask st_1487265575"></div>
                                          <div class="bg-img" style="background-image:url(images/viva_las_vegas_2048x1365.jpg);"></div>
                                       </div>
                                       <div class="bg-holder full">
                                          <div class="bg-mask st_1487265575"></div>
                                          <div class="bg-img" style="background-image:url(images/el_inevitable_paso_del_tiempo_2048x2048.jpg);"></div>
                                       </div>
                                       <div class="bg-holder full">
                                          <div class="bg-mask st_1487265575"></div>
                                          <div class="bg-img" style="background-image:url(images/196_365_800x6001.jpg);"></div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="row row-wrap">
                                    <div class="col-md-3 col-sm-6 col-xs-12 loop-curved ">
                                       <div class="thumb">
                                          <header class="thumb-header">
                                             ...
                                             <img width="263" height="197" src="images/gaviota_en_el_top_800x6001-263x197.jpg" class="attachment-263x197x1 size-263x197x1 wp-post-image" alt="" srcset="images/gaviota_en_el_top_800x6001-263x197.jpg 263w, images/gaviota_en_el_top_800x6001.jpg 800w, images/gaviota_en_el_top_800x6001-278x208.jpg 278w" sizes="(max-width: 263px) 100vw, 263px" />                        <i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
                                             </a>
                                          </header>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 loop-curved ">
                                       <div class="thumb">
                                          <header class="thumb-header">
                                             <a href="#">
                                             <img width="263" height="197" src="images/sydney_harbour_800x600-263x197.jpg" class="attachment-263x197x1 size-263x197x1 wp-post-image" alt="" srcset="images/sydney_harbour_800x600-263x197.jpg 263w, images/sydney_harbour_800x600-360x270.jpg 360w, images/sydney_harbour_800x600.jpg 800w, images/sydney_harbour_800x600-98x74.jpg 98w" sizes="(max-width: 263px) 100vw, 263px" />                        <i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
                                             </a>
                                          </header>
                                          <div class="thumb-caption">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 loop-curved ">
                                       <div class="thumb">
                                          <header class="thumb-header">
                                             <a href="#" class="hover-img curved">
                                             <img width="263" height="197" src="images/Cruise-demo-2-263x197.jpg" class="attachment-263x197x1 size-263x197x1 wp-post-image" alt="" srcset="images/Cruise-demo-2-263x197.jpg 263w, images/Cruise-demo-2-800x600.jpg 800w, images/Cruise-demo-2-360x270.jpg 360w, images/Cruise-demo-2-98x74.jpg 98w, images/Cruise-demo-2-278x208.jpg 278w, images/Cruise-demo-2.jpg 1600w" sizes="(max-width: 263px) 100vw, 263px" />                        <i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
                                             </a>
                                          </header>
                                          <div class="thumb-caption">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 loop-curved ">
                                       <div class="thumb">
                                          <header class="thumb-header">
                                             <a href="#" class="hover-img curved">
                                             <img width="263" height="197" src="images/taxi-263x197.jpg" class="attachment-263x197x1 size-263x197x1 wp-post-image" alt="" srcset="images/taxi-263x197.jpg 263w, images/taxi-800x600.jpg 800w, images/taxi-360x270.jpg 360w, images/taxi-98x74.jpg 98w, images/taxi-278x208.jpg 278w" sizes="(max-width: 263px) 100vw, 263px" />                        <i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
                                             </a>
                                          </header>
                                          <div class="thumb-caption">
      ...
      <link rel='stylesheet' id='st-select.css-css'  href='css/st-select.css' type='text/css' media='all' />
      ...
      <script type='text/javascript' src='js/select-flight-location.js'></script>
