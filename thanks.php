...
<html lang="en-US">
   ...
   <body class="page-template-default page page-id-5200 logged-in woocommerce-checkout woocommerce-page woocommerce-order-received  wide menu_style1 topbar_position_default enable_sticky_menu wpb-js-composer js-comp-ver-5.0 vc_responsive">
         ...
         <div class="row" id="st_header_wrap_inner">
                  ...
                  <div class="row">
                     ...
                     <div class='col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right right_topbar top-user-area'>
                        ...
                        <ul class="top-user-area-list list list-horizontal list-border clearfix">
                           ...
                           <li><a href="mailto:info@heystranger.co.za" target=""> <i class="fa fa-envelope-o mr5"></i>info@heystranger.co.za</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <header id="main-header" class="st_menu" >
               <div class="header-top ">
                  <div class="container">
                     <div class="row">
                        <div class="col-md-3">
                           <a class="logo" href="#">
                           <img  width='110px' height ='40px'  src="images/logo-white.png" alt="logo" title="Traveler">
                           </a>
                        </div>
                        <div class="col-md-9">
                           <div class="top-user-area clearfix">
                              <ul class="top-user-area-list list list-horizontal list-border">
                                 <li class="top-user-area-avatar">
                                    <a href="#">
                                    <img alt="avatar" width=40 height=40 src="images/1-339crqgskq7y3gptopwykg.jpg" class="avatar avatar-96 photo origin round" >Hey Stranger        </a>
                                 </li>
                                 <li>        <a class="btn-st-logout" href="#">Sign Out</a>
                                 </li>
                                 ...
                                 <li class="top-user-area-lang nav-drop">
                                    ...
                                    <img  height="12px" width= "18px" src="images/en.png" alt="English" title="English">English<i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i>
                                    </a>
                                    <ul class="list nav-drop-menu" style="min-width:120px">
                                       <li>
                                          <a title="Français" href="#">
                                          <img height="12px" width= "18px" src="images/fr.png" alt="Français" title="Français"><span class="right">Français</span>
                                          </a>
                                       </li>
                                       <li>
                                          <a title="Deutsch" href="#">
                                          <img height="12px" width= "18px" src="images/de.png" alt="Deutsch" title="Deutsch"><span class="right">Deutsch</span>
                                          </a>
                                       </li>
               ...
               <div class="main_menu_wrap" id="menu1">
                  <div class="container" >
                     <div class="nav">
                        <ul id="slimmenu" data-title="<a href='#'><img width=auto height=40px class=st_logo_mobile src=images/logo-white.png /></a>" class="menu slimmenu">
                           ...
                           <li id="menu-item-1304" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1304">
                              <a>Pages</a>
                           ...
                           <li id="menu-item-4728" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-4728">
                              <a href="#">Tours</a>
                              
                           </li>
                           <li id="menu-item-4749" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-4749">
                              <a href="#">Rentals</a>
                             
                           </li>
                           <li id="menu-item-5137" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5137">
                              <a href="#">Partner</a>
                             
                           </li>
                           <li id="menu-item-12083" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-12083">
                              <a href="#">Location</a>
                           ...
                           <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  slimmenu-sub-menu st_menu_mobile_new" >
                              <a href="#">English <img  height="12px" width= "18px" src="images/en.png" alt="English" title="English"></a>
                              <ul class="sub-menu" style="display: none;">
                                 <li>
                                    <a title="Français" href="#">
                                    <span class="right">Français</span> <img height="12px" width= "18px" src="images/fr.png" alt="Français" title="Français">
                                    </a>
                                 </li>
                                 <li>
                                    <a title="Deutsch" href="#">
                                    <span class="right">Deutsch</span> <img height="12px" width= "18px" src="images/de.png" alt="Deutsch" title="Deutsch">
                                    </a>
                                 </li>
                           ...
                           <div class="woocommerce">
                              ...
                              <div class="row">
                                 <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <h2 class="text-center">Hey Stranger, your order has been received!</h2>
                                    <h5 class="text-center mb30">Booking details has been send to yourmail@gmail.com</h5>
                                 </div>
                              </div>
                              ...
                              <ul class="order-payment-list list mb30">
                                 <li class="order_item">
                                    <div class="row">
                                       <div class="col-xs-9">
                                          <h5><i class=""></i>
                                             <a href="http://travelerdemo.wpengine.com/hotel/holiday-inn-express-kennedy-airport/">Grand Hyatt Hotel</a>
                                          </h5>
                                       </div>
                                       <div class="col-xs-3">
                                          <p class="text-right"><span class="text-lg">R200,39</span>
                                          </p>
                                       </div>
                                    </div>
                                    <div class="order-item-meta-box">
                                       <ul class="wc-order-item-meta-list">
                                          <li>
                                             ...
                                             <span class="meta-data"><a href="#">Executive Room With Lake View</a></span>
                                          </li>
                                          <li>
                                             <span class="meta-label">Date:</span>
                                             <span class="meta-data">02/21/2017                                    <i class="fa fa-long-arrow-right"></i>
                                             02/22/2017                            </span>
                                          </li>
                                          <li>
                                             <span class="meta-label">Adult:</span>
                                             <span class="meta-data">1</span>
                                          </li>
                                          <li>
                                             <span class="meta-label">Children:</span>
                                             <span class="meta-data">0</span>
                                          </li>
                                          <li>
                                             <span class="meta-label">Number of rooms:</span>
                                             <span class="meta-data">1</span>
                                             x
                                             <span class="meta-price">R222,66</span>
                                          </li>
                                          </p></li>
                                          </p></li>
                                       </ul>
                                 ...
                                 <li class="order_item">
                                    <div class="row">
                                       <div class="col-xs-9">
                                          <h5><i class=""></i>
                                             <a href="#">Wellington Paris Hotel</a>
                                          </h5>
                                       </div>
                                       <div class="col-xs-3">
                                          <p class="text-right"><span class="text-lg">R312,61</span>
                                          </p>
                                       </div>
                                    </div>
                                    <div class="order-item-meta-box">
                                       <ul class="wc-order-item-meta-list">
                                          <li>
                                             <span class="meta-label">Room:</span>
                                             <span class="meta-data"><a href="http://travelerdemo.wpengine.com/hotel_room/junior-suite-7/">Junior Suite</a></span>
                                          </li>
                                          <li>
                                             <span class="meta-label">Date:</span>
                                             <span class="meta-data">02/21/2017                                    <i class="fa fa-long-arrow-right"></i>
                                          ...
                                          <li>
                                             ...
                                             <span class="meta-data">2</span>
                                             x
                                             <span class="meta-price">R173,67</span>
                                          </li>
                                          </p></li>
                                          </p></li>
                                       </ul>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-xs-3">
                                    <p class="text-right">
                                       ...
                                       <span class="text-lg">£513,01</span>
                                    </p>
                                 </div>
                              </div>
                              <header>
                              ...
                              <table class="shop_table shop_table_responsive customer_details">
                                 <tr>
                                    <th>Email:</th>
                                    <td data-title="Email">yourmail@gmail.com</td>
                                 </tr>
                                 <tr>
                                    <th>Telephone:</th>
                                    <td data-title="Telephone">315644898798</td>
                                 </tr>
                              </table>
                              <header class="title">
                              ...
                              <address>
                                 ASDF<br/>ASDF ASDF<br/>ADF<br/>ASDF<br/>ASDF<br/>KOWLOON<br/>Hong Kong
                              </address>
                              <div class="clear"></div>
                              <style>
                                 .page-title{
      ...
      <div class="demo_changer" id="demo_changer">
         ...
         <div class="form_holder">
            ...
            <div class="predefined_styles" id="patternswitch_area">
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: 0px 0 ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/binding_light.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -25px 0 ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/binding_dark.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -50px 0 ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/dark_fish_skin.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -75px 0 ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/dimension.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -100px 0 ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/escheresque_ste.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -125px 0 ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/food.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -0px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/giftly.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -25px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/grey_wash_wall.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -50px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/ps_neutral.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -75px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/pw_maze_black.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -100px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/pw_pattern.png"></a>
               <a class="patternswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/demo.png);background-position: -125px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/patterns/simple_dashed.png"></a>
            </div>
            <div class="line"></div>
            <p>Background Images</p>
            <div class="predefined_styles" id="bgimageswitch_area">
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -25px 0 ; " data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/bike.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -25px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/flowers.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -50px -75px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/wood.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -25px -75px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/taxi.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -25px -50px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/demo.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -50px -50px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/road.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -50px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/keyboard.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -0px -0px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/beach.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -0px -75px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/street.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -0px -50px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/nature.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -50px -0px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/bridge.jpg"></a>
               <a class="bgimageswitch" href="#" style="background-image: url(http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/switcher/demo.jpg);background-position: -00px -25px ;" data-src="http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/img/backgrounds/cameras.jpg"></a>
            </div>
            <div class="line"></div>
         </div>
      </div>
      ...
      <script type="text/html" id="tmpl-media-library-view-switcher">
         <a href="/checkout-2/order-received/21353/?key=wc_order_58a983d140b5e&#038;mode=list" class="view-list">
         	<span class="screen-reader-text">List View</span>
         </a>
         <a href="/checkout-2/order-received/21353/?key=wc_order_58a983d140b5e&#038;mode=grid" class="view-grid current">
      ...
      <script type="text/html" id="tmpl-site-icon-preview">
         ...
         <div class="favicon-preview">
         	<img src="https://travelerdemo.wpengine.com/wp-admin/images/browser.png" class="browser-preview" width="182" height="" alt="" />
         
         	<div class="favicon">
         		<img id="preview-favicon" src="{{ data.url }}" alt="Preview as a browser icon"/>
         	</div>
         	<span class="browser-title" aria-hidden="true">Traveler</span>
         </div>
      ...
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/contact-form-7/includes/js/jquery.form.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var _wpcf7 = {"loaderUrl":"http:\/\/travelerdemo.wpengine.com\/wp-content\/plugins\/contact-form-7\/images\/ajax-loader.gif","recaptchaEmpty":"Please verify that you are not a robot.","sending":"Sending ...","cached":"1"};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/contact-form-7/includes/js/scripts.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/woocommerce/assets/js/select2/select2.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var woocommerce_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/checkout-2\/order-received\/21353\/?key=wc_order_58a983d140b5e&wc-ajax=%%endpoint%%"};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
      ...
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/woocommerce/assets/js/frontend/country-select.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
      ...
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/woocommerce/assets/js/frontend/address-i18n.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var wc_checkout_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/checkout-2\/order-received\/21353\/?key=wc_order_58a983d140b5e&wc-ajax=%%endpoint%%","update_order_review_nonce":"c2959902b9","apply_coupon_nonce":"79d30aeac9","remove_coupon_nonce":"26a3d5f2ea","option_guest_checkout":"yes","checkout_url":"\/checkout-2\/order-received\/21353\/?key=wc_order_58a983d140b5e&wc-ajax=checkout","is_checkout":"0","debug_mode":"1","i18n_checkout_error":"Error processing checkout. Please try again."};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/woocommerce/assets/js/frontend/checkout.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/woo_fix/jquery_cookie.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var wc_cart_fragments_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/checkout-2\/order-received\/21353\/?key=wc_order_58a983d140b5e&wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/modernizr.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/bootstrap.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/jquery.slimmenu.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/jquery.form.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/icheck.js'></script>
      ...
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/infobox.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/noty/packaged/jquery.noty.packaged.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/init/class.notice.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/init/booking_modal.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/jquery.mousewheel-3.0.6.pack.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/admin/custom-price.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/custom.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/custom2.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/init/social-login.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/sticky.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/tour_version.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/iconpicker/js/fontawesome-iconpicker.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/iconpicker/js/custom-iconpicker.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/jquery.scrollTo.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/hover_effect.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/underscore.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/shortcode.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/backbone.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var _wpUtilSettings = {"ajax":{"url":"\/wp-admin\/admin-ajax.php"}};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/wp-util.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/wp-backbone.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var _wpMediaModelsL10n = {"settings":{"ajaxurl":"\/wp-admin\/admin-ajax.php","post":{"id":0}}};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/media-models.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         ...
         var _wpPluploadSettings = {"defaults":{"runtimes":"html5,flash,silverlight,html4","file_data_name":"async-upload","url":"\/wp-admin\/async-upload.php","flash_swf_url":"http:\/\/travelerdemo.wpengine.com\/wp-includes\/js\/plupload\/plupload.flash.swf","silverlight_xap_url":"http:\/\/travelerdemo.wpengine.com\/wp-includes\/js\/plupload\/plupload.silverlight.xap","filters":{"max_file_size":"52428800b","mime_types":[{"extensions":"jpg,jpeg,jpe,gif,png,bmp,tiff,tif,ico,asf,asx,wmv,wmx,wm,avi,divx,flv,mov,qt,mpeg,mpg,mpe,mp4,m4v,ogv,webm,mkv,3gp,3gpp,3g2,3gp2,txt,asc,c,cc,h,srt,csv,tsv,ics,rtx,css,vtt,dfxp,mp3,m4a,m4b,ra,ram,wav,ogg,oga,mid,midi,wma,wax,mka,rtf,js,pdf,class,tar,zip,gz,gzip,rar,7z,psd,xcf,doc,pot,pps,ppt,wri,xla,xls,xlt,xlw,mdb,mpp,docx,docm,dotx,dotm,xlsx,xlsm,xlsb,xltx,xltm,xlam,pptx,pptm,ppsx,ppsm,potx,potm,ppam,sldx,sldm,onetoc,onetoc2,onetmp,onepkg,oxps,xps,odt,odp,ods,odg,odc,odb,odf,wp,wpd,key,numbers,pages"}]},"multipart_params":{"action":"upload-attachment","_wpnonce":"d212c9d5f0"}},"browser":{"mobile":false,"supported":true},"limitExceeded":false};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/plupload/wp-plupload.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/jquery/ui/core.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/jquery/ui/widget.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/jquery/ui/mouse.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/jquery/ui/sortable.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
      ...
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/mediaelement/mediaelement-and-player.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/mediaelement/wp-mediaelement.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var _wpMediaViewsL10n = {"url":"URL","addMedia":"Add Media","search":"Search","select":"Select","cancel":"Cancel","update":"Update","replace":"Replace","remove":"Remove","back":"Back","selected":"%d selected","dragInfo":"Drag and drop to reorder media files.","uploadFilesTitle":"Upload Files","uploadImagesTitle":"Upload Images","mediaLibraryTitle":"Media Library","insertMediaTitle":"Insert Media","createNewGallery":"Create a new gallery","createNewPlaylist":"Create a new playlist","createNewVideoPlaylist":"Create a new video playlist","returnToLibrary":"\u2190 Return to library","allMediaItems":"All media items","allDates":"All dates","noItemsFound":"No items found.","insertIntoPost":"Insert into post","unattached":"Unattached","trash":"Trash","uploadedToThisPost":"Uploaded to this post","warnDelete":"You are about to permanently delete this item.\n  'Cancel' to stop, 'OK' to delete.","warnBulkDelete":"You are about to permanently delete these items.\n  'Cancel' to stop, 'OK' to delete.","warnBulkTrash":"You are about to trash these items.\n  'Cancel' to stop, 'OK' to delete.","bulkSelect":"Bulk Select","cancelSelection":"Cancel Selection","trashSelected":"Trash Selected","untrashSelected":"Untrash Selected","deleteSelected":"Delete Selected","deletePermanently":"Delete Permanently","apply":"Apply","filterByDate":"Filter by date","filterByType":"Filter by type","searchMediaLabel":"Search Media","searchMediaPlaceholder":"Search media items...","noMedia":"No media files found.","attachmentDetails":"Attachment Details","insertFromUrlTitle":"Insert from URL","setFeaturedImageTitle":"Featured Image","setFeaturedImage":"Set featured image","createGalleryTitle":"Create Gallery","editGalleryTitle":"Edit Gallery","cancelGalleryTitle":"\u2190 Cancel Gallery","insertGallery":"Insert gallery","updateGallery":"Update gallery","addToGallery":"Add to gallery","addToGalleryTitle":"Add to Gallery","reverseOrder":"Reverse order","imageDetailsTitle":"Image Details","imageReplaceTitle":"Replace Image","imageDetailsCancel":"Cancel Edit","editImage":"Edit Image","chooseImage":"Choose Image","selectAndCrop":"Select and Crop","skipCropping":"Skip Cropping","cropImage":"Crop Image","cropYourImage":"Crop your image","cropping":"Cropping\u2026","suggestedDimensions":"Suggested image dimensions:","cropError":"There has been an error cropping your image.","audioDetailsTitle":"Audio Details","audioReplaceTitle":"Replace Audio","audioAddSourceTitle":"Add Audio Source","audioDetailsCancel":"Cancel Edit","videoDetailsTitle":"Video Details","videoReplaceTitle":"Replace Video","videoAddSourceTitle":"Add Video Source","videoDetailsCancel":"Cancel Edit","videoSelectPosterImageTitle":"Select Poster Image","videoAddTrackTitle":"Add Subtitles","playlistDragInfo":"Drag and drop to reorder tracks.","createPlaylistTitle":"Create Audio Playlist","editPlaylistTitle":"Edit Audio Playlist","cancelPlaylistTitle":"\u2190 Cancel Audio Playlist","insertPlaylist":"Insert audio playlist","updatePlaylist":"Update audio playlist","addToPlaylist":"Add to audio playlist","addToPlaylistTitle":"Add to Audio Playlist","videoPlaylistDragInfo":"Drag and drop to reorder videos.","createVideoPlaylistTitle":"Create Video Playlist","editVideoPlaylistTitle":"Edit Video Playlist","cancelVideoPlaylistTitle":"\u2190 Cancel Video Playlist","insertVideoPlaylist":"Insert video playlist","updateVideoPlaylist":"Update video playlist","addToVideoPlaylist":"Add to video playlist","addToVideoPlaylistTitle":"Add to Video Playlist","settings":{"tabs":[],"tabUrl":"https:\/\/travelerdemo.wpengine.com\/wp-admin\/media-upload.php?chromeless=1","mimeTypes":{"image":"Images","audio":"Audio","video":"Video"},"captions":true,"nonce":{"sendToEditor":"0c6afdba14"},"post":{"id":0},"defaultProps":{"link":"","align":"","size":""},"attachmentCounts":{"audio":0,"video":1},"embedExts":["mp3","ogg","wma","m4a","wav","mp4","m4v","webm","ogv","wmv","flv"],"embedMimes":{"mp3":"audio\/mpeg","ogg":"audio\/ogg","wma":"audio\/x-ms-wma","m4a":"audio\/mpeg","wav":"audio\/wav","mp4":"video\/mp4","m4v":"video\/mp4","webm":"video\/webm","ogv":"video\/ogg","wmv":"video\/x-ms-wmv","flv":"video\/x-flv"},"contentWidth":null,"months":[{"year":"2017","month":"2","text":"February 2017"},{"year":"2017","month":"1","text":"January 2017"},{"year":"2016","month":"12","text":"December 2016"},{"year":"2016","month":"11","text":"November 2016"},{"year":"2016","month":"10","text":"October 2016"},{"year":"2016","month":"9","text":"September 2016"},{"year":"2016","month":"8","text":"August 2016"},{"year":"2016","month":"7","text":"July 2016"},{"year":"2016","month":"6","text":"June 2016"},{"year":"2016","month":"5","text":"May 2016"},{"year":"2016","month":"3","text":"March 2016"},{"year":"2016","month":"1","text":"January 2016"},{"year":"2015","month":"12","text":"December 2015"},{"year":"2015","month":"11","text":"November 2015"},{"year":"2015","month":"10","text":"October 2015"},{"year":"2015","month":"9","text":"September 2015"},{"year":"2015","month":"8","text":"August 2015"},{"year":"2015","month":"7","text":"July 2015"},{"year":"2015","month":"6","text":"June 2015"},{"year":"2015","month":"5","text":"May 2015"},{"year":"2015","month":"4","text":"April 2015"},{"year":"2015","month":"3","text":"March 2015"},{"year":"2015","month":"2","text":"February 2015"},{"year":"2015","month":"1","text":"January 2015"},{"year":"2014","month":"12","text":"December 2014"},{"year":"2014","month":"11","text":"November 2014"}],"mediaTrash":0}};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/media-views.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/media-editor.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/media-audiovideo.min.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-includes/js/wp-embed.min.js'></script>
      <script type='text/javascript'>
         /* <![CDATA[ */
         var icl_vars = {"current_language":"en","icl_home":"http:\/\/travelerdemo.wpengine.com"};
         /* ]]> */
      </script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/sitepress-multilingual-cms/res/js/sitepress.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/handlebars-v2.0.0.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/typeahead.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/bootstrap-datepicker.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/themes/traveler140/js/bootstrap-timepicker.js'></script>
      <script type='text/javascript' src='http://z8e0944c0fq469vst36jkhqn.wpengine.netdna-cdn.com/wp-content/plugins/js_composer/assets/js/dist/js_composer_front.min.js'></script>
